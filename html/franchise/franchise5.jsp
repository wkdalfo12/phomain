...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
 <script type="text/javascript" src="/phomein/lib/js/franchise5.js"></script>
            ...
            <div id="contents" class="mt30">
              <div class="event_div">
                ...
                <div class="counseling_div mt15">
                  	 		...
                  	 		<tbody>
                  	 			<tr>
                  	 				...
                  	 				<td class="type02">
                  	 					...
                  	 					<input type="radio" name="PF_Type" id="PF_Type3" class="checkbox unt3" value="2" style="margin:3px 0 0 "/>
                  	 			...
                  	 			<tr class="type-view01" style="display:none;">
                  	 				<td class="type01">
                  	 			...
                  	 			<tr class="type-view02">
                  	 				<td class="type01">
                  	 					<img style="vertical-align:middle"src="/phomein/lib/img/franchise/e/phone_txt05.gif" alt="거주지" />
                  	 				</td>
                  	 				<td class="type02">
                  	 					<select style="width:60px; height:24px;" name="hp1" id="hp1">
                  	 					...
                  	 					<input type="text" name="PF_Gugun" id="PF_Gugun" value="" style="margin-left:7px;width:124px; padding:3px;"/> 
                  	 					
                  	 				</td>
                  	 			</tr>
                  	 			<tr class="type-view04">
                  	 				<td class="type01">
                  	 			...
                  	 			<tr class="type-view03" style="display:none;">
                  	 				<td class="type01">
                  	 			...
                  	 			<tr class="type-view05" style="display:none;">
                  	 				<td class="type01">
                  	 					<img style="vertical-align:middle"src="/phomein/lib/img/franchise/e/store_ver_txt01.gif" alt="추천점포지" />
                  	 				</td>
                  	 			<td class="type02">
                  	 					<input type="text" name="PF_Recommend" id="PF_Recommend" style="width:134px;padding:3px;"  />
                  ...
                  <div class="inqBest" style="display:none;">
	                  	<p class="mt15">
	                  		<img src="/phomein/lib/img/franchise/e/store_ver_txt.gif" alt="세부사항 임대조건" />
	                  	</p>
	                  	<div class="board_type01">
	                  		<table>
	                  			<colgroup>
	                  			...
	                  			<tbody>
	                  				<tr>
	                  					<td class="type01"><img src="/phomein/lib/img/franchise/e/store_ver_txt02.gif" style="margin-top:4px;" alt="보증금" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Deposit" id="PF_Deposit"/>
	                  						<label for="PF_Deposit">만원</label>
	                  					</td>
	                  					<td class="type01" ><img src="/phomein/lib/img/franchise/e/store_ver_txt03.gif" style="margin-top:4px;" alt="실평수" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Space" id="PF_Space"/>
	                  						<label for="PF_Space">평</label>
	                  					</td>
	                  				</tr>
	                  				<tr>
	                  					<td class="type01"><img src="/phomein/lib/img/franchise/e/store_ver_txt04.gif" style="margin-top:4px;" alt="층수" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Deposit" id="PF_Deposit"/>
	                  						<label for="PF_Deposit">층</label>
	                  					</td>
	                  					<td class="type01" ><img src="/phomein/lib/img/franchise/e/store_ver_txt05.gif" style="margin-top:4px;" alt="월임대료" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Space" id="PF_Space"/>
	                  						<label for="PF_Space">만원</label>
	                  					</td>
	                  				</tr>
	                  				<tr>
	                  					<td class="type01"><img src="/phomein/lib/img/franchise/e/store_ver_txt02.gif" style="margin-top:4px;" alt="권리금" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Deposit" id="PF_Deposit"/>
	                  						<label for="PF_Deposit">만원</label>
	                  					</td>
	                  					<td class="type01" ><img src="/phomein/lib/img/franchise/e/store_ver_txt07.gif" style="margin-top:4px;" alt="관리비" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Space" id="PF_Space"/>
	                  						<label for="PF_Space">만원</label>
	                  					</td>
	                  				...
	                  				<tr>
	                  					<td class="type01"><img src="/phomein/lib/img/franchise/e/store_ver_txt08.gif" style="margin-top:4px;" alt="공개수수료" /></td>
	                  					<td class="type02">
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Deposit" id="PF_Deposit"/>
	                  						<label for="PF_Deposit">만원</label>
	                  					</td>
	                  					<td class="type01" ><img src="/phomein/lib/img/franchise/e/store_ver_txt09.gif" style="margin-top:4px;" alt="주차가능대수" /></td>
	                  					<td class="type02">
	                  						<input type="radio" id="PF_ParkingYN1" name="PF_ParkingYN" class="checkbox" style="margin-top:4px;padding:3px 0 0 6px;"/>
	                  						<label for="PF_ParkingYN1">있음</label>
	                  						<input type="text" style="width:52px;padding:3px;" name="PF_Space" id="PF_Space"/>
	                  						<label for="PF_Space">대</label>
	                  						<input type="radio" id="PF_ParkingYN2" name="PF_ParkingYN" class="checkbox" style="margin-top:4px;padding:3px 0 0 6px;"/>
	                  						<label for="PF_ParkingYN2">없음</label>
	                  					</td>
	                  				</tr>
	                  				<tr>
	                  					<td class="type01"><img src="/phomein/lib/img/franchise/e/store_ver_txt010.gif" style="margin-top:4px;" alt="입점가능시기" /></td>
	                  					<td colspan="3" class="type02">
	                  						<input type="text" style="width:77px;padding:3px;" name="PF_Deposit" id="PF_Deposit"/>
	                  						<label for="PF_Deposit"><a href=""><img src="/phomein/lib/img/franchise/e/icon_calendar.gif" style="margin:2px 0 0 2px;" alt="" /></label>
	                  					</td>
