			 		...
			 		<div class="store_div">
			 				<div class="p_box">
			 						<div class="storeview01_left">
			 								<p class="big">
			 									<img class="on" src="/phomein/lib/img/store/a/a_711.jpg" alt="원주혁신도시점" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_71.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_72.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_73.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 								</p>
			 								<div class="sum mt15">
			 										<ul>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지1" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_712.jpg)0px 0px no-repeat;"/>
			 											...
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지2" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_713.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>	
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지3" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_714.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지4" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_715.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 								...
			 								<table class="mt15">
			 									...
			 									<tbody>
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">강원 원주시 반곡동 1886-5 2층</td>
			 										</tr>
			 										<tr>
			 											<td class="type01"><img src="/phomein/lib/img/store/a/search_store_view_txt02.gif" alt="주소" /></td>
			 											<td class="type02" style="color:#666">033-733-2755</td>
			 										</tr>
			 										<tr>
			 										...
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">일반 6, 7, 84, 86</td>
			 										</tr>
			 										<tr>
...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 37.323309, lng: 127.981663},
    zoom: 16
  });
  var image = '/phomein/lib/img/store/a/marker.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 37.323309, lng: 127.981663},
    map: map,
    icon: image
  });
