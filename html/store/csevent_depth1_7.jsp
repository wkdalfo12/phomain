			 		...
			 		<div class="store_div">
			 				<div class="p_box">
			 						<div class="storeview01_left">
			 								<p class="big">
			 									<img class="on" src="/phomein/lib/img/cscenter/csevent/b_771.jpg" alt="부평CGV점" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_711.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_712.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_713.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 								</p>
			 								<div class="sum mt15">
			 										<ul>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지1" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_772.jpg)0px 0px no-repeat;"/>
			 											...
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지2" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_773.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>	
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지3" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_774.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지4" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_775.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
...
function initMap(x,y,message) {
  map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 37.521819, lng: 126.703470},
    zoom: 16
  });
  var image = '/phomein/lib/img/store/a/marker.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 37.521819, lng: 126.703470},
    map: map,
    icon: image
  });
