			 		...
			 		<div class="store_div">
			 				<div class="p_box">
			 						<div class="storeview01_left">
			 								<p class="big">
			 									<img class="on" src="/phomein/lib/img/store/a/a_41.jpg" alt="의정부민락점" style="height: 221px;width: 295px;"/>
			 								...
			 								<div class="sum mt15">
			 										<ul>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지1" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_411.jpg)0px 0px no-repeat;"/>
			 											...
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지2" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_412.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>	
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지3" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_413.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지4" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/store/a/a_414.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 								...
			 								<table class="mt15">
			 									...
			 									<tbody>
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">경기 의정부시 민락동 809번지 폴리프라자Ⅲ 203호</td>
			 										</tr>
			 										<tr>
			 											<td class="type01"><img src="/phomein/lib/img/store/a/search_store_view_txt02.gif" alt="주소" /></td>
			 											<td class="type02" style="color:#666">031-853-8022</td>
			 										</tr>
			 										<tr>
			 										...
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">일반 8-1, 35, 72-1 직행 3600</td>
			 										</tr>
			 										<tr>
...
function initMap() {
  map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 37.7449716, lng: 127.1000086},
    zoom: 16
  });
  var image = '/phomein/lib/img/store/a/marker.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 37.7449716, lng: 127.1000086},
    map: map,
    icon: image
  });
