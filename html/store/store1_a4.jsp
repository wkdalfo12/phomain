	    	...
	    	<!-- 테이블 -->		           
						           <div class="board_type02 mt15">
						                <table>
							                     ...
							                     <tr style="cursor:pointer;">
							                      			 ...
							                      			 <tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">이천점</a></td>
							                      			     <td class="taL type03">경기 이천시 어재연로 40 2층</td>
							                      			     <td class="type01">031-638-6679</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">김포사우점</a></td>
							                      			     <td class="taL type03">경기 김포시 사우중로 45</td>
							                      			     <td class="type01">031-983-5515</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">동판교점</a></td>
							                      			     <td class="taL type03">경기 성남시 분당구 대왕판교로 660 1동 313호 (삼평동, 유스페이스)</td>
							                      			     <td class="type01">031-628-6712</td>
							                      			     <td class="type01">AM11:00~PM10:30</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">평택뉴코아점</a></td>
							                      			     <td class="taL type03">경기 평택시 경기대로 279, 7층 전문식당가</td>
							                      			     <td class="type01">031-650-6577</td>
							                      			     <td class="type01">AM10:30~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">홍제점</a></td>
							                      			     <td class="taL type03">서울 서대문구 통일로 397,</td>
							                      			     <td class="type01">02-736-4444</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">수원삼성디지털시티점</a></td>
							                      			     <td class="taL type03">경기 수원시 영통구 삼성로 176-1, 3층</td>
							                      			     <td class="type01">031-213-0852</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">포항양덕점</a></td>
							                      			     <td class="taL type03">경북 포항시 북구 천마로 73</td>
							                      			     <td class="type01">054-254-1160</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">용산아이파크몰점</a></td>
							                      			     <td class="taL type03">서울 용산구 한강대로23길 55, 서관 지상7층</td>
							                      			     <td class="type01">02-2012-0723</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">마석점</a></td>
							                      			     <td class="taL type03">경기 남양주시 화도읍 마석우리 383-2 중앙프라자 202호</td>
							                      			     <td class="type01">031-594-9870</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr>
							                      			<tr style="cursor:pointer;">
							                      			     <td class="taL"><a href="">구리토평점</a></td>
							                      			     <td class="taL type03">경기 구리시 수택동 874-5번지 2층</td>
							                      			     <td class="type01">031-564-3888</td>
							                      			     <td class="type01">AM11:00~PM10:00</td>
							                      			</tr> 
							                     </tbody>
						                </table>
						           ...
						           <div class="paging mt30">
						               		<p>
						                          ...
						                          <a href="/phomein/html/store/store1_a3.jsp" class="prev"><img src="/phomein/lib/img/store/a/paging_pre.gif" alt="" /></a>
						                          <a href="/phomein/html/store/store1.jsp">1</a>
						                          <a href="/phomein/html/store/store1_a1.jsp">2</a>
						                          <a href="/phomein/html/store/store1_a2.jsp">3</a>
						                          <a href="/phomein/html/store/store1_a3.jsp">4</a>
						                          <strong>5</strong>
						                          <a href="/phomein/html/store/store1_a5.jsp" class="next"><img src="/phomein/lib/img/store/a/paging_next.gif" alt="" /></a>
