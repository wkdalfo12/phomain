			 		...
			 		<div class="store_div">
			 				<div class="p_box">
			 						<div class="storeview01_left">
			 								<p class="big">
			 									<img class="on" src="/phomein/lib/img/cscenter/csevent/b_1010.jpg" alt="부평CGV점" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_1011.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_1012.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_1013.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 								</p>
			 								<div class="sum mt15">
			 										<ul>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지1" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_1011.jpg)0px 0px no-repeat;"/>
			 											...
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지2" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_1012.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>	
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지3" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_1013.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지4" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_1014.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 								...
			 								<table class="mt15">
			 									...
			 									<tbody>
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">인천 부평구 마장로 489, 3층</td>
			 										</tr>
			 										<tr>
			 											<td class="type01"><img src="/phomein/lib/img/store/a/search_store_view_txt02.gif" alt="주소" /></td>
			 											<td class="type02" style="color:#666">032-270-2825~6</td>
			 										</tr>
			 										<tr>
			 										...
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">722, 551, 103, 14-1, 2, 586, 103-1</td>
			 										</tr>
			 										<tr>
...
function initMap(x,y,message) {
  map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 37.521798, lng: 126.703459},
    zoom: 16
  });
  var image = '/phomein/lib/img/store/a/marker.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 37.521798, lng: 126.703459},
    map: map,
    icon: image
  });
