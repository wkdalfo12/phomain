			 		...
			 		<div class="store_div">
			 				<div class="p_box">
			 						<div class="storeview01_left">
			 								<p class="big">
			 									<img class="on" src="/phomein/lib/img/cscenter/csevent/b_551.jpg" alt="평택뉴코아점" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_511.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_512.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 									<img src="/phomein/lib/img/store/a/da_513.jpg" alt="큰이미지" style="height: 221px;width: 295px;"/>
			 								...
			 								<div class="sum mt15">
			 										<ul>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지1" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_552.jpg)0px 0px no-repeat;"/>
			 											...
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지2" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_553.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>	
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지3" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_554.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 											<li>
			 												<div class="sum_unit">
			 													<a href="">
			 														<img src="/phomein/lib/img/store/a/gif.gif" alt="스몰이미지4" height="48px" width="67px" style="height:48px; width:67px; background: url(/phomein/lib/img/cscenter/csevent/b_555.jpg)0px 0px no-repeat;"/>
			 														<span ><img src="/phomein/lib/img/store/a/search_store_view_on.png" alt="" /></span>
			 													</a>
			 												</div>
			 											</li>
			 								...
			 								<table class="mt15">
			 									...
			 									<tbody>
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">경기 평택시 경기대로 279, 7층 전문식당가</td>
			 										</tr>
			 										<tr>
			 											<td class="type01"><img src="/phomein/lib/img/store/a/search_store_view_txt02.gif" alt="주소" /></td>
			 											<td class="type02" style="color:#666">031-650-6577</td>
			 										</tr>
			 										<tr>
			 										...
			 										<tr>
			 											...
			 											<td class="type02" style="color:#666">100,100-1,1-1,13,14,15,15-1,15-2,15-3,15-4,17,3-5,49-2,49-4,57-1,57-2,57-4,7-1,7-2,90-3,91,91-1,94,94-1,좌석81,좌석810,좌석98</td>
			 										</tr>
			 										<tr>
			 											<td class="type01"><img src="/phomein/lib/img/store/a/search_store_view_txt05.gif" alt="주소" /></td>
			 											<td class="type02" style="color:#666"></td>
			 										</tr>
			 										<tr>
...
function initMap(x,y,message) {
  map = new google.maps.Map(document.getElementById('map'), {
    center: {lat: 36.995540, lng: 127.112421},
    zoom: 16
  });
  var image = '/phomein/lib/img/store/a/marker.png';
  var beachMarker = new google.maps.Marker({
    position: {lat: 36.995540, lng: 127.112421},
    map: map,
    icon: image
  });
