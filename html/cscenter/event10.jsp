	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">[페이스북 이벤트] 스파이시 포와 연극 <룸넘버 13>을 한번에 즐기고 싶다면?</th>
	   									<th class="taR">2013-07-25 ~ 2013-08-08</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="margin-left:40px;" src="/phomein/lib/img/cscenter/csevent/e10.jpg" alt="이벤트이미지" />
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
