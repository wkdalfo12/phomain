...
.view_div p{text-align:center;}
.view_div .pp1{margin-top:5px;padding-top:15px;}
.view_div span{color:#9a9a9a;font-size:12px;}
.out{
text-indent :-9999px;
overflow:hidden;
}
	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">신학기 맞이 스페셜 이벤트! 스페셜 메뉴 3종 20% 할인</th>
	   									<th class="taR">2015-02-09 ~ 2015-03-15</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="width:600px;height:837px;" src="/phomein/lib/img/cscenter/csevent/aa_9.jpg" alt="이벤트이미지" />
	   											<p class="pp1"><span>* 치킨 앤 베지와 비프 청크 포는 매장별로 순차 판매되고 있으며, </span></p>
		   										<p><span>현재 일부 매장에서는 제공되지 않으므로 유의바랍니다.</span></p>
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
