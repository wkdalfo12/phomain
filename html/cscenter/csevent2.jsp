...
<body>
	  ...
	  <div id="wrapper">
	   ...
	   <h6 class="out">포메인 이벤트</h6> 
	   			<div id="titleimg">
	   				<h3><img src="/phomein/lib/img/cscenter/csevent/event_tit.gif" alt="포메인이벤트" /></h3>
	   			</div>
	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">새해맞이 월남쌈 세트 할인 이벤트!</th>
	   									<th class="taR">2015-12-01 ~ 2016-02-29</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="width:642px;height:453px;margin-left:9px;" src="/phomein/lib/img/cscenter/csevent/aa_2.jpg" alt="이벤트이미지" />
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
