	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">뮤지컬 <황태자 루돌프> 초대이벤트! '나만의 가을 여행지'를 추천해 주세요!</th>
	   									<th class="taR">2014-09-19 ~ 2014-09-30</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="margin-left:30px;" src="/phomein/lib/img/cscenter/csevent/e03.jpg" alt="이벤트이미지" />
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
