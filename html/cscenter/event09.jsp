	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">[10월 블로그 문화이벤트] 포메인과 SK나이츠를 향한 응원의 덧글을 남겨주세요! 뮤지컬 <아가씨와 건달들> 초대권 이벤트</th>
	   									<th class="taR">2013-10-04 ~ 2013-10-24</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="margin-left:80px;" src="/phomein/lib/img/cscenter/csevent/e09.jpg" alt="이벤트이미지" />
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
