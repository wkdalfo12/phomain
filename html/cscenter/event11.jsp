	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">[포메인 7월 문화이벤트] 올 여름 스페셜 프리미엄 보양식은? 뮤지컬 <아메리칸 이디엇> 초대이벤트!</th>
	   									<th class="taR">2013-07-19 ~ 2013-08-08</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										<div class="view_div">
	   											<img style="margin-left:40px;" src="/phomein/lib/img/cscenter/csevent/e11.jpg" alt="이벤트이미지" />
	   										</div>
	   									</td>
	   								</tr>
	   							</tbody>
