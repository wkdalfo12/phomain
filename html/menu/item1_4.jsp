...
overflow:hidden;
 ...
 .sum_div a span{display:block;position: absolute;bottom:227px;width: 70px;height: 53px;}
 .sum_div a span img{display:none;}
 .sum_div a span:hover img{display:block;z-index:10;}
</style>
	  ...
	  <div id="wrapper">
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	    <h6 class="out">쌀국수</h6>  
	   			<div id="titleimg">
	   				<h3>
	   					<img src="/phomein/lib/img/menu/menu_item/imenu1/soup_tit.gif">
	   				</h3>
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu1/item1_4b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									M4 매운 해산물 쌀국수 Seafood Spicy Pho
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 매운 해산물 쌀국수 Seafood Spicy Pho</strong>
	   							</p>
	   							<p class="mt10">
	   								꽃게, 새우, 소라, 오징어, 주꾸미 등의 다양한 해산물을 넣은 매운 쌀국수
	   							</p>
	   							<p>
	   							 	Spicy Seafood Pho (Crab, Shrimps, Conch, Squids)
	   							</p>
	   							...
	   							<p class="price_spec mt5">
	   								...
	   								<span class="price">L <span class="number">13,000</span>
	   								</span>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu1/item1_4s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
