...
overflow:hidden;
  ...
  .sum_div span{position: absolute;bottom:262px;display:block;width: 70px;height: 53px;}
	  ...
	  <div id="wrapper">
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	      <h6 class="out">월남쌈</h6>  
	   			<div id="titleimg">
	   				<h3>
	   					<img src="/phomein/lib/img/menu/menu_item/imenu2/roll_tit.gif">
	   				</h3>
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu2/item2_3b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									H3 포메인 쌈(월남쌈) 패밀리 세트 Phomein Wrap Family Combo
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 포메인 쌈(월남쌈) 패밀리 세트 Phomein Wrap Family Combo</strong>
	   							</p>
	   							<p class="mt10">
	   								포메인 쌈 (3-4인용) + 포메인쌀국수(S) 2개 + 닭고기 볶음밥 + 탄산음료 4잔 **고기선택 가능 (닭고기 또는 소고기)
	   							</p>
	   							<p>
	   							 	Phomein Wrap (L) + 2 Beef Combination Pho (S) + Chicken Fried Rice + 4 Soft Drinks **Choice of Chicken or Beef
	   							</p>
	   							
	   							<p class="price_spec mt5">
	   								<span class="price">69,000
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu2/item2_3s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
