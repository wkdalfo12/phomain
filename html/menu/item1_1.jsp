	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu1/item1_1b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									M1 포메인 쌀국수 Beef Combination Pho
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 포메인 쌀국수 Beef Combination Pho</strong>
	   							</p>
	   							<p class="mt10">
	   								양지, 차돌이 들어간 얇게 썰은 고기 토핑의 담백한 쌀국수
	   							</p>
	   							<p>
	   							 	Combination of Boiled Beef Pho
	   							</p>
	   							...
	   							<p class="price_spec mt5">
	   								...
	   								<span class="price">L <span class="number">11,000</span>
	   								</span>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png" alt="img" class="crop" width="70px" height="53px" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
