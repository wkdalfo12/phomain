	    ...
	    <h6 class="out">스페셜 메뉴</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu5/item5_2b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									PS2 치킨 앤 베지 Chicken & Veggie
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 치킨 앤 베지 Chicken & Veggie</strong>
	   							</p>
	   							<p class="mt10">
	   								버섯, 가지, 시금치 등 각종 채소와 닭고기를 매콤한 포메인 특제 소스와 함께 볶아낸 요리
	   							</p>
	   							<p>
	   							 	Stir Fried Chicken with Fresh Mixed Vegetables
	   							</p>
	   							
	   							<p class="price_spec mt5">
	   								<span class="price">19,500
	   								</span>
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu5/item5_2s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
