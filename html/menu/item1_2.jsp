...
overflow:hidden;
 ...
 .sum_div a span:hover img{z-index:10;display:block;}
</style>
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu1/item1_2b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									M2 스파이시 포 Beef Spicy Pho
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 스파이시 포 Beef Spicy Pho</strong>
	   							</p>
	   							<p class="mt10">
	   								깔끔하고 개운한 맛의 매운 소고기 쌀국수
	   							</p>
	   							<p>
	   							 	Spicy Beef Pho (Boiled Beef)
	   							</p>
	   							...
	   							<p class="price_spec mt5">
	   								...
	   								<span class="price">L <span class="number">12,000</span>
	   								</span>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu1/item1_2s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
