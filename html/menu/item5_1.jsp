...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:227px;display:block;width: 70px;height: 53px;}
	  ...
	  <div id="wrapper">
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	    <h6 class="out">스페셜 메뉴</h6>  
	   			<div id="titleimg">
	   				<h3>
	   					<img src="/phomein/lib/img/menu/menu_item/imenu5/special_tit.gif">
	   				</h3>
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu5/item5_1b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									PS1 포메인 깐풍기 Fried Cashew Nuts Chicken
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 포메인 깐풍기 Fried Cashew Nuts Chicken</strong>
	   							</p>
	   							<p class="mt10">
	   								바삭하게 튀긴 닭다리살에 각종 야채, 캐슈넛을 함께 볶은 매콤달콤 고소한 맛의 요리
	   							</p>
	   							<p>
	   							 	Deep Fried Chicken Mixed with Cashew Nuts and Vegetables
	   							</p>
	   							
	   							<p class="price_spec mt5">
	   								<span class="price">18,500
	   								</span>
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu5/item5_1s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
