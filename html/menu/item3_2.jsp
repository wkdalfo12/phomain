...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:243px;display:block;width: 70px;height: 53px;}
	      ...
	      <h6 class="out">볶음국수</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu3/item3_2b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									S2 소고기 플랫 누들 Fried Beef Flat Noodle
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 소고기 플랫 누들 Fried Beef Flat Noodle</strong>
	   							</p>
	   							<p class="mt10">
	   								넓은 쌀국수 면과 부드러운 소고기를 신선한 청경채, 각종 야채와 함께 볶아낸 포메인의 인기 메뉴
	   							</p>
	   							<p>
	   							 	Stir Fried Rice Noodle with Sliced Beef and Fresh Vegetables
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu3/item3_2s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
