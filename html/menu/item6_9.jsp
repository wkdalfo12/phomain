...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:255px;display:block;width: 70px;height: 53px;}
...
<body>
	  ...
	  <div id="wrapper">
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	   	 <h6 class="out">에피타이져</h6>  
	   			<div id="titleimg">
	   				<h3>
	   					<img src="/phomein/lib/img/menu/menu_item/imenu6/appetizer_tit.gif">
	   				</h3>
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu6/item6_9b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									A9 짜조 Vietnamese Style Spring Roll
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 짜조 Vietnamese Style Spring Roll</strong>
	   							</p>
	   							<p class="mt10">
	   								돼지고기와 새우 그리고 신선한 야채를 다져 쌀피에 말아 튀긴 베트남식 튀김 롤 (Small(4pcs) Large(8pcs))
	   							<p>
	   							 	Fried Spring Roll Filled with Vegetables, Shrimp, Pork (Small(4pcs) Large(8pcs))
	   							</p>
	   							...
	   							<p class="price_spec mt5">
	   								...
	   								<span class="price">L <span class="number">12,000(8pcs)</span>
	   								</span>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a>
	   									<img src="/phomein/lib/img/menu/menu_item/imenu6/item6_9s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
