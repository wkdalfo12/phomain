...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:185px;display:block;width: 70px;height: 53px;}
	      ...
	      <h6 class="out">월남쌈</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu2/item2_4b.jpg" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									H4 월남쌈 테이크아웃 서비스 Take Out Service
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 월남쌈 테이크아웃 서비스 Take Out Service</strong>
	   							</p>
	   							<p class="mt10">
	   								집에서도 맛있는 월남쌈을 즐겨보세요!
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu2/item2_4s.jpg" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
