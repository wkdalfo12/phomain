	  ...
	  <div id="wrapper">
	   ...
	   <%@ include  file="../gnb/header.jsp" %> 
	      <h6 class="out">볶음국수</h6>  
	   			<div id="titleimg">
	   				<h3>
	   					<img src="/phomein/lib/img/menu/menu_item/imenu3/menu_tit.gif">
	   				</h3>
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu3/item3_1b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									S1 매운 해산물 볶음 쌀국수 Seafood Fried Noodle
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 매운 해산물 볶음 쌀국수 Seafood Fried Noodle</strong>
	   							</p>
	   							<p class="mt10">
	   								쌀국수와 각종 해산물을 신선한 야채, 계란과 함께 칠리소스로 볶아낸 매콤한 볶음 쌀국수
	   							</p>
	   							<p>
	   							 	Stir Fried Rice Noodle with Seafood and Fresh Vegetables (Spicy)
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu3/item3_1s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
