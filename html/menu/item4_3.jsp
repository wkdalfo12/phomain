	    ...
	    <h6 class="out">볶음밥</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu4/item4_3b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									R3 닭고기 볶음밥 Chicken Fried Rice
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 닭고기 볶음밥 Chicken Fried Rice</strong>
	   							</p>
	   							<p class="mt10">
	   								닭고기, 양파, 계란, 버섯, 피망 등을 포메인의 특제소스로 볶아낸 담백한 볶음밥

	   							</p>
	   							<p>
	   							 	Stir Fried Rice with Chicken, Eggs, Mushrooms, Onions and Vegetables
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu4/item4_3s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
