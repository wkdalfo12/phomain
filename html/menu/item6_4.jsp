...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:240px;display:block;width: 70px;height: 53px;}
	    ...
	    <h6 class="out">에피타이져</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu6/item6_4b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									A4 포메인 치킨윙 Phomein’s Chicken Wings
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 포메인 치킨윙 Phomein’s Chicken Wings</strong>
	   							</p>
	   							<p class="mt10">
	   								닭 어깨 튀김 (Small(4pcs) Large(10pcs))
	   							<p>
	   							 	Deep-Fried Chicken Wings (Small(4pcs) Large(10pcs))
	   							</p>
	   							...
	   							<p class="price_spec mt5">
	   								...
	   								<span class="price">L <span class="number">13,500(10pcs)</span>
	   								</span>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu6/item6_4s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
