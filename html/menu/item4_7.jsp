...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:225px;display:block;width: 70px;height: 53px;}
	    ...
	    <h6 class="out">볶음밥</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu4/item4_7b.png" alt="img">
	   						</p>
	   						
	   						<div class="p_box mt30">
	   							<div class="spec">
	   								<span class="pageTitle" style="display:none;">
	   									R7 닭고기 덮밥 Rice Topped with Chicken
	   								</span>
	   							...
	   							<p class="tit mt15">
	   								<strong> 닭고기 덮밥 Rice Topped with Chicken</strong>
	   							</p>
	   							<p class="mt10">
	   								메밀 간장에 비벼 먹는 닭고기 덮밥
	   							</p>
	   							<p>
	   							 	Chicken Rice with Soy Sauce
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu4/item4_7s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
