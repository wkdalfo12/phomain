...
overflow:hidden;
 ...
 .sum_div span{position: absolute;bottom:245px;display:block;width: 70px;height: 53px;}
	    ...
	    <h6 class="out">스페셜 메뉴</h6>  
	   			...
	   			<div id="contents" class="mt30">
	   				<div class="special_div">
	   					<div class="view">
	   						<p>
	   							<img id="detailImg" src="/phomein/lib/img/menu/menu_item/imenu5/item5_3b.png" alt="img">
	   						</p>
	   						...
	   						<div class="p_box mt30">
	   							...
	   							<p class="tit mt15">
	   								<strong> 분보싸오 Bun Bo Xao</strong>
	   							</p>
	   							<p class="mt10">
	   								부드러운 소고기와 달콤한 파인애플을 양파와 함께 볶아낸 후, 신선한 야채, 쌀국수와 함께 피쉬소스로 비벼먹는 건강 메뉴
	   							</p>
	   							<p>
	   							 	Rice Noodle Mixed with Fresh Vegetables and Stir Fried Beef
	   							</p>
	   							
	   							<p class="price_spec mt5">
	   								<span class="price">13,500
	   								</span>
	   							</p>
	   						...
	   						<div class="sum">
	   							...
	   							<div class="sum_div">
	   								<a href="">
	   									<img src="/phomein/lib/img/menu/menu_item/imenu5/item5_3s.png" alt="img" class="crop" width="70" height="53" style="height: 53px; width: 70px; background: url("/phomein/lib/img/menu/menu_item/imenu1/item1_1s.png") 0px 0px no-repeat;">
