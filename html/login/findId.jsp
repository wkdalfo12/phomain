...
<body>
	  ...
	  <div id="wrapper">
	   ...
	   <h6 class="out">아이디 찾기</h6>  
	   				<div id="titleimg">
	   				<h3><img src="/phomein/lib/img/login/find/tit_forgot_id.gif" alt="" /></h3>
	   				</div>
	   				<div id="contents" class="mt30">
	   					...
	   					<ul class="tab">
	   						...
	   						<li><a href="/phomein/html/login/findId.jsp"><img src="/phomein/lib/img/login/find/login_tab03_on.gif" alt="" /></a></li>
	   						<li><a href="/phomein/html/login/findPw.jsp"><img src="/phomein/lib/img/login/login_tab04.gif" alt="" /></a></li>
	   					</ul>
	   					<form action="">
	   						<div class="join_box mt40">
	   							<div class="join_process02">
	   								<div class="box_txt mt15">
	   									<img src="/phomein/lib/img/login/find/blt_info.gif" alt="" /> 이름과 회원 가입시 등록한 이메일 주소를 입력하여 주세요.
	   								</div>
