	   					...
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">
포메인 본사 (주)데일리킹, ‘제 47회 납세자의 날’ 국세청장표창 수상!</th>
	   									<th class="taR">2013-03-04</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										...
	   										<p class="taC"></p>
	   											...
	   											<p align="center">
	   												<img style="width: 660px; height: 958px;" name="setBbsImg" border="0" name="setBbsImg" src="/phomein/lib/img/about/news/sang.jpg">
	   											...
	   											<strong> 신뢰받는 포메인!</strong>
	   											</span>
	   												</p>
	   											<br>
	   											<p align="center">포메인 본사 (주)데일리킹이 '제 47회 납세자의 날' 모범납세자로 선정되어 국세청장표창을 수상하였습니다.
	   											
	   											</p>
	   											
	   											<p align="center">
	   											 
고객에게 신뢰 받는 기업, 믿음으로 보답하는 기업이 되겠습니다. 감사합니다. 
	   											</p>
	   					...
	   					<div class="board_type06 mt30">
	   						...
	   						<tbody>
	   							<tr>
	   								...
	   								<a href="/phomein/html/about/news/news9.jsp">
	   									포메인은 다릅니다! 100% 천연향신료로 만든 '포메인 허브팩'을 공개합니다!
	   								</a>
	   								</td>
	   								<td>2013-11-20</td>
	   								...
	   								<td class="taL">
	   									<a href="/phomein/html/about/news/news11.jsp">
