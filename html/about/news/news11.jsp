	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">포메인, 신한은행과 ‘프랜차이즈론’ 협약 체결</th>
	   									<th class="taR">2012-11-23</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										...
	   										<p class="taC"></p>
	   											...
	   											<span style="color: rgb(31, 73, 125); font-family:'맑은 고딕'; font-size:18px; font-weight: bold;">
	   											<p align="center">
	   											<strong>
	   											포메인, 신한은행과 '프랜차이즈론' 협약 체결
	   											</strong>
	   											</p>
	   											</span>
	   											...
	   											<p align="center">
	   												<img style="width: 442px; height: 293px;" name="setBbsImg" border="0" name="setBbsImg" src="/phomein/lib/img/about/news/franchise.jpg">
	   										
	   											</p>
	   											
	   											<span style="font-style: 맑은 고딕;font-size:14px; color: black; ">
	   											<p align="center"> 김대일 ㈜데일리킹 대표(사진 왼쪽)와 조석환 신한은행 중소기업고객부장이</p>
	   											
	   											
	   											
	   											<p align="center"> 프랜차이즈론 협약 체결 후 기념촬영을 하고 있다.
	   											...
	   											<span style="font-style:맑은 고딕; font-size:16px; color:black;">
	   											
	   											<p>
	   											베트남 쌀국수 전문점 포메인(㈜데일리킹, 대표 김대일)이 지난 19일 신한은행과 손잡고 예비 가맹점주와 기존 가맹점주를 위한 ‘프랜차이즈론’ 협약을 체결했다.
	   											...
	   											<p>
	   											신한은행 프랜차이즈론은 안전도, 인지도, 향후 발전 가능성, 비전 등의 심사기준을 통과한 우량 프랜차이즈 본사만을 대상으로 하며 가맹점주에게 한도액 내에서 무담보 저금리 대출을 해주는 제도이다. 
	   											...
	   											<p>
	   											포메인 신규 가맹점주는 임차보증금과 인테리어 비용 등 총 창업소요자금의 1/2 범위 내에서, 기존 가맹점주는 최근 3개월간 매출액 또는 최근 1년 매출액의 1/4 범위 내에서 최고 7천만원까지 대출이 가능하며 금리는 신용등급별로 차등 적용된다.
	   					...
	   					<div class="board_type06 mt30">
	   						...
	   						<tbody>
	   							<tr>
	   								...
	   								<a href="/phomein/html/about/news/news10.jsp">
	   									포메인 본사 (주)데일리킹, ‘제 47회 납세자의 날’ 국세청장표창 수상!
	   								...
	   								<td class="taL">
	   									<a href="/phomein/html/about/news/news12.jsp">
	   										프리미엄 매운 쌀국수 '스파이시 포' 출시!
	   									</a>
