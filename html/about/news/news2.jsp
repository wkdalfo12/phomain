...
#wrapper{ 
 ...
 .board_type05 td .view_div{width: 660px; height: 5359px; padding:50px 19px 30px; border-left:1px #e1ded8 solid;border-right:1px #e1ded8 solid;}
.mt25{margin-top: 25px;}
	   				...
	   				<div class="event_div">
	   					<div class="board_type05 mt15">
	   						<table>
	   							...
	   							<thead>
	   								<tr>
	   									<th class="taL">GIFT PHO YOU! 이제 카카오톡 선물하기로 포메인을 선물하세요!</th>
	   									<th class="taR">2015-07-31</th>
	   								</tr>
	   							</thead>
	   							<tbody>
	   								<tr>
	   								...
	   								<tr>
	   									<td colspan="2">
	   										...
	   										<p class="taC"></p>
	   											...
	   											<img style="width:660px; height:5279px;" src="/phomein/lib/img/about/news/kakaotalkgift.jpg" alt="이벤트이미지" />
	   											</div>
	   					...
	   					<div class="board_type06 mt30">
	   						...
	   						<tbody>
	   							<tr>
	   								...
	   								<a href="/phomein/html/about/news/news1.jsp">
	   									포메인, 중국 상해에 1호점 개점! 첫 해외시장 진출
	   								...
	   								<td class="taL">
	   									<a href="/phomein/html/about/news/news3.jsp">
	   										[하나카드 제휴] 5~6월 포메인에서 '식샤 카드'로 결제 시 15% 할인
	   									</a>
